...
def main():
    """Generate the benchmark test-data tree described on the command line."""
    parser = argparse.ArgumentParser(description="Generate test data for benchmarks")
    parser.add_argument("--output-dir", "-o", type=Path, default="test_files", help="Output directory for test files")
    parser.add_argument(
        "--sizes",
        nargs="+",
    ...
    parser.add_argument("--patterns", nargs="+", default=["mixed", "zeros", "random"], help="Data patterns to generate")
    parser.add_argument("--directories", action="store_true", help="Generate test directories")
