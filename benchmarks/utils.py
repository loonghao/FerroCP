...
def create_test_directory(
    path: Path, num_files: int = 10, file_size: int = 1024, num_subdirs: int = 3, pattern: str = "mixed"
) -> Path:
...
def measure_copy_performance(copy_func, source: Path, dest: Path, iterations: int = 1) -> dict[str, float]:
