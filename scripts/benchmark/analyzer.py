...
try:
    ...
    HAS_PLOTLY = False
    print(
        "Warning: Analysis dependencies not available. Install with: "
        "pip install pandas numpy matplotlib seaborn pyyaml plotly"
    )
...
class PerformanceAnalyzer:
    ...
    def _default_config(self) -> dict:
        ...
        return {
            ...
            "reporting": {"metrics": ["mean", "median", "stddev", "min", "max"], "chart_formats": ["png", "html"]},
        }
    ...
    def save_results(self, data: list[dict], metadata: dict, regressions: list[dict], improvements: list[dict]):
...
def main():
    """Analyze the benchmark data referenced on the command line."""
    parser = argparse.ArgumentParser(description="FerroCP Performance Analyzer")
    parser.add_argument("--data-dir", default="benchmark-artifacts", help="Directory containing benchmark data")
    parser.add_argument("--baseline-dir", default="baseline-results", help="Directory containing baseline data")
    parser.add_argument("--config", default=".github/performance-config.yml", help="Configuration file path")
    parser.add_argument("--output-dir", default="performance-results", help="Output directory for results")
